      ...
      <div className="mt-16 flex flex-col items-start gap-8 sm:flex-row">
        <div className="sm:flex-1">
          <div className="prose prose-neutral dark:prose-invert">
            {/* biome-ignore lint/suspicious/noExplicitAny: basehub types don't match fragment inference */}
            <Body content={page.body.json.content as any} />
          </div>
        </div>
        <div className="sticky top-24 hidden shrink-0 md:block">
          <Sidebar
            ...
            // biome-ignore lint/suspicious/noExplicitAny: basehub types don't match fragment inference
            toc={<TableOfContents data={page.body.json.toc as any} />}
          />
        </div>
      </div>
    </div>
